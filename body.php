...
$valid_pages = ['home', 'about', 'services', 'clients', 'contact'];
...
<section id="main">
      ...
      <div class="side-navbar nav-shadow" style="order:3">
         ...
         <div id="mySidenav" class="sidenav" style="max-width: 0px; width: 0px;">
            <div class="sidebar-content">
               ...
               <a href="#" onclick="loadContent('home')">Home</a></a>
   ...
   <!-- Main  Content -->
   <div class="content" style="overflow-y:scroll!important; order:2; left:0px;">
